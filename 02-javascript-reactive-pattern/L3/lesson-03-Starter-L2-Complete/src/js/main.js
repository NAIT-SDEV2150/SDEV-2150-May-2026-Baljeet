...
const resultComponent = document.querySelector('resource-results');
resultComponent.results = resultData;
...
resultComponent.addEventListener('resource-selected', (event)=>{
